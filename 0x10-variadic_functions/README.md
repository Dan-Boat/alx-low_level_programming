...
In this project, I used variadic fucntions to design some print funtions. I used 
functions like  `va_start`, `va_arg`, and `va_end` macros as well as why and how to use the `const` type qualifier in C.
